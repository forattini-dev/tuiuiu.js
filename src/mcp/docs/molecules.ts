...
export const molecules: ComponentDoc[] = [
  ...
  },
  {
    ...
    props: [
      { name: 'items', type: "AutocompleteItem<T>[]", required: true, description: 'Available autocomplete items' },
      { name: 'initialValues', type: "T[]", required: false, default: '[]', description: 'Initially added values' },
      ...
      { name: 'fullWidth', type: "boolean", required: false, default: 'false', description: 'Expand to fill available width' },
      { name: 'colorTag', type: "ColorValue", required: false, default: "'primary'", description: 'Tag color' },
  ...
  },
  {
    ...
    props: [
      { name: 'entries', type: "Array<{ key: string; value: unknown; color?: string }> | Record<string, unknown>", required: true, description: 'Key-value entries' },
      ...
      { name: 'valueColor', type: "ColorValue", required: false, default: "'foreground'", description: 'Value text color' },
  ...
  },
  {
    ...
    props: [
      { name: 'children', type: "VNode", required: true, description: 'Panel content' },
      { name: 'active', type: "boolean", required: false, default: 'true', description: 'Whether to render the panel' },
      { name: 'padding', type: "number", required: false, default: '0', description: 'Panel padding' },
    ],
    examples: [
      `TabPanel({\n  active: tabsState.activeKey() === 'home',\n  children: Text({}, 'Home content'),\n})`,
    ],
  ...
  },
  {
    ...
    props: [
      { name: 'initialDate', type: "Date", required: false, description: 'Initially displayed month/year' },
      { name: 'selectedDates', type: "Date[]", required: false, description: 'Selected dates' },
  ...
  // =============================================================================
  {
    ...
    props: [
      ...
      { name: 'language', type: "Language", required: false, default: "'plain'", description: 'Programming language (typescript, javascript, python, rust, go, etc.)' },
      { name: 'theme', type: "CodeTheme", required: false, description: 'Syntax highlighting theme' },
      { name: 'lineNumbers', type: "boolean", required: false, default: 'true', description: 'Show line numbers' },
      ...
      { name: 'borderColor', type: "ColorValue", required: false, description: 'Border color' },
      { name: 'filename', type: "string", required: false, description: 'Filename displayed in the header' },
    ],
    examples: [
      `CodeBlock({\n  code: 'const x = 1;\\nconst y = 2;',\n  language: 'typescript',\n  lineNumbers: true,\n})`,
