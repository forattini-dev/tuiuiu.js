...
export interface PromptModeResolver {
...
export interface PromptModeResolverOptions {
...
export function createPromptModeResolver(
  options: PromptModeResolverOptions
): PromptModeResolver {
